console.log("Ejercicio 1: Ensalada de frutas");
...
let frutas = ["Limon", "Pera", "kiwi", "Sandia", "Uva"];
for (let i in frutas) {
    console.log("Las frutas que hay en la ensalada son: " + frutas[i]);
}


console.log("Ejercicio 2: Promedio de edad");
...
console.log("Ejercicio 3: Mis amigos");
...
console.log("Ejercicio 4: Métodos de arrays");
...
console.log("El elemento shampoo existe, su indice es: " + listaDeSuper.indexOf("shampoo"));


console.log("Ejercicio 5: Mi primera función");
...
function saludo() {
    alert("Bienvenido pollo");
}

console.log("Invocame, me llamo saludo()");


console.log("Ejercicio 6: Calculando el mayor")
...
console.log("Invocame, me llamo calculoMayor(), y pasame dos numeros");


console.log("Ejercicio 7: Mis amigos")
...
console.log("Ejercicio 8: Tirar dados");
...
console.log("Invocame, me llamo tirarDado()");


console.log("Ejercicio 9: Creando y consultando un objeto");
...
let toDoList = {
    ...
    dia: "Jueves",
    productos: ["Mani, Chocolate, Papitas, Pomelo"],
    "cantidad de productos": 4,
    estado: "pendiente",
    notificacion: setTimeout(() => {
...
console.log("Ejercicio 10: Consultando valores");
...
console.log("Ejercicios de métodos avanzados de arrays EJERCICIO 1: Mis amigos");
...
console.log(amigo.filter(filtro));

function filtro(nombreAmigo) {
    return nombreAmigo.length === 4;
}

console.log("EJERCICIO 2: Corrigeme la frase");
...
console.log(frases);
console.log(frases.map(addSign));
